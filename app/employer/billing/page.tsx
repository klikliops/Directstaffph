  ...
  return (
    <div className="mx-auto w-full max-w-5xl px-4 py-10 sm:px-6 lg:px-8">
      ...
      <p className="mt-1 text-slate-600">
        You&rsquo;re currently on the Free plan. Upgrade to unlock contact
        info, video intros, and direct messaging.
      </p>
      ...
      <div className="mt-8 grid grid-cols-1 gap-6 md:grid-cols-3">
        {PRICING_PLANS.map((plan) => (
          ...
          >
            ...
            <div className="mt-5">
              {plan.id === "free" ? (
                <span className="inline-flex w-full items-center justify-center rounded-full bg-slate-100 px-5 py-2.5 text-sm font-semibold text-slate-600">
                  Current Plan
                </span>
              ) : (
                <span className="block text-center text-xs text-slate-500">
                  Billing isn&rsquo;t connected yet &mdash; contact us to
                  upgrade.
                </span>
              )}
            </div>
