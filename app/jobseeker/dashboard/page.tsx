...
import { JobseekerTopbar } from "@/components/jobseeker/topbar";
import { ProfileProgress } from "@/components/jobseeker/profile-progress";
...
export default function JobseekerDashboardPage() {
  ...
  return (
    <div className="flex min-h-full flex-1 flex-col bg-slate-50">
      <JobseekerTopbar username={session?.username ?? null} />
      ...
      <main className="mx-auto w-full max-w-6xl flex-1 px-4 py-10 sm:px-6 lg:px-8">
        ...
        <div className="mt-6 grid grid-cols-1 gap-6 lg:grid-cols-5">
          <div className="lg:col-span-2">
            <ProfileProgress hasMobileNumber={Boolean(session?.mobileNumber)} />
          </div>
